    ...
    <div class="footer-grid">
      <div class="footer-brand">
        ...
        <div style="margin-top: 20px; display:flex; gap:15px; font-size: 20px;">
            <a href="#" style="color:var(--text-muted);">&#x1F4F7;</a> <!-- Camera emoji as proxy for IG -->
            <a href="#" style="color:var(--text-muted);">&#x1F426;</a> <!-- Bird emoji as proxy for Twitter -->
            <a href="#" style="color:var(--text-muted);">&#x1F4FA;</a> <!-- TV emoji as proxy for YT -->
        </div>
      </div>
