...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_movie'])) {
    $title = $_POST['title'] ?? '';
    $genre = $_POST['genre'] ?? '';
    $price = $_POST['price'] ?? 150;
    $rating = $_POST['rating'] ?? 'PG-13';
    $duration = $_POST['duration'] ?? '120 min';
    $language = $_POST['language'] ?? 'English';
    $emoji = '🍿';
    $banner_url = "https://images.unsplash.com/photo-1536440136628-849c177e76a1?w=800&q=80"; 
    $backdrop_url = "https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?w=1600&q=80"; 
...
<div class="admin-layout">
    <div class="admin-sidebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li><a href="panel_admin_manage_movies.php">Manage Movies</a></li>
                ...
                while ($row = pg_fetch_assoc($res)) {
                    echo "<tr>
                        ...
                        <td style='display: flex; gap: 10px;'>
                            <a href='panel_admin_edit_movie.php?id={$row['id']}' class='btn btn-primary' style='padding: 6px 12px; background: #2196F3; border-color: #2196F3;'>Edit</a>
